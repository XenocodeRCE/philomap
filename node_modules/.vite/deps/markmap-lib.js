    ...
    (function webpackUniversalModuleDefinition(root, factory) {
      ...
      return (
        ...
        function() {
          ...
          var SS = 6;
          var SSc = 7;
          var styles2 = [new Style(D, 0, false), new Style(Dc, 0, true), new Style(T, 1, false), new Style(Tc, 1, true), new Style(S, 2, false), new Style(Sc, 2, true), new Style(SS, 3, false), new Style(SSc, 3, true)];
          ...
          var makeOrd = function makeOrd2(group, options, type) {
            ...
            if (text2.charCodeAt(0) === 55349) {
              var _wideCharacterFont = wideCharacterFont(text2, mode);
          ...
          var Namespace = function() {
            ...
            _proto.set = function set(name2, value, global) {
              if (global === void 0) {
                global = false;
              }
              if (global) {
          ...
          var Parser = function() {
            ...
            _proto.parseRegexGroup = function parseRegexGroup(regex, modeName) {
              ...
              var str = "";
              var nextToken2;
              while ((nextToken2 = this.fetch()).text !== "EOF" && regex.test(str + nextToken2.text)) {
