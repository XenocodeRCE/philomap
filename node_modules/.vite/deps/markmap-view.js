...
function dsv_default(delimiter) {
  ...
  function parseRows(text, f) {
    ...
    function token() {
      ...
      return eof = true, text.slice(j, N2);
    }
    while ((t = token()) !== EOF) {
      var row = [];
      while (t !== EOL && t !== EOF)
...
function D3(e, t) {
  return Array.isArray(e) ? Ct(e.map((n) => D3(n, t))) : _(e, t);
}
function _(e, t = zt) {
...
function jt(e) {
  var t = this, n, i = [t], r, a2, c3;
  do
    for (n = i.reverse(), i = []; t = n.pop(); )
      if (e(t), r = t.children, r)
        for (a2 = 0, c3 = r.length; a2 < c3; ++a2)
          i.push(r[a2]);
  while (i.length);
  return this;
}
...
function Rt(e) {
  for (var t = this, n = [t], i = [], r, a2, c3; t = n.pop(); )
...
function L(e, t) {
  var n = new R(e), i = +e.value && (n.value = e.value), r, a2 = [n], c3, s2, l, f;
  for (t == null && (t = _t); r = a2.pop(); )
    if (i && (r.value = +r.data.value), (s2 = t(r.data)) && (f = s2.length))
      for (r.children = new Array(f), l = f - 1; l >= 0; --l)
        a2.push(c3 = r.children[l] = new R(s2[l])), c3.parent = r, c3.depth = r.depth + 1;
...
function Q(e) {
  ...
  function r() {
    ...
    return class q extends L.prototype.constructor {
      ...
      copy() {
        const h = c3(this.constructor, this, (p) => p.children);
  ...
  function a2() {
    const s2 = r(), l = n("nodeSize"), f = n("spacing");
  ...
  function c3(s2, l, f) {
    const h = (p, m) => {
      ...
      const S = f(p) || [];
      return d.children = S.length === 0 ? null : S.map((x3) => h(x3, d)), d.children && Object.assign(d, d.children.reduce(
        (x3, g) => ({
          height: Math.max(x3.height, g.height + 1),
          length: x3.length + g.length
        }),
        d
      )), d;
    };
  ...
  return Object.assign(i, {
    ...
    dump(s2) {
      const l = n("nodeSize"), f = (h) => (p) => {
        const m = h + "  ", d = h + "    ", { x: S, y: x3 } = p, g = l(p), y3 = p.children || [], v2 = y3.length === 0 ? " " : `,${m}children: [${d}${y3.map(f(d)).join(d)}${m}],${h}`;
        return `{ size: [${g.join(", ")}],${m}x: ${S}, y: ${x3}${v2}},`;
      };
      return f(`
`)(s2);
    }
...
var tt = (e, t = 0) => (e.y = t, (e.children || []).reduce((n, i) => {
  const [r, a2] = n;
  tt(i, e.y + e.ySize);
  const c3 = (r === 0 ? i.lExt : i.rExt).bottom;
  r !== 0 && se(e, r, a2);
  const s2 = fe(c3, r, a2);
  return [r + 1, s2];
}, [0, null]), re2(e), pe(e), e);
...
var re2 = (e) => {
  (e.children || []).reduce((t, n) => {
    const [i, r] = t, a2 = i + n.shift, c3 = r + a2 + n.change;
    return n.relX += c3, [a2, c3];
  }, [0, 0]);
};
var se = (e, t, n) => {
  const i = e.children[t - 1], r = e.children[t];
  let a2 = i, c3 = i.relX, s2 = r, l = r.relX, f = true;
  for (; a2 && s2; ) {
    ...
    const p = a2.bottom, m = s2.bottom;
    p <= m && (a2 = he(a2), a2 && (c3 += a2.relX)), p >= m && (s2 = ce2(s2), s2 && (l += s2.relX));
  }
  !a2 && s2 ? de2(e, t, s2, l) : a2 && !s2 && ue(e, t, a2, c3);
};
var ae = (e, t) => {
  e.relX += t, e.lExtRelX += t, e.rExtRelX += t;
};
var le = (e, t, n, i) => {
  const r = e.children[t], a2 = t - n;
  if (a2 > 1) {
    const c3 = i / a2;
    e.children[n + 1].shift += c3, r.shift -= c3, r.change -= i - c3;
  }
};
var ce2 = (e) => e.hasChildren ? e.firstChild : e.lThr;
var he = (e) => e.hasChildren ? e.lastChild : e.rThr;
var de2 = (e, t, n, i) => {
  const r = e.firstChild, a2 = r.lExt, c3 = e.children[t];
  a2.lThr = n;
  const s2 = i - n.relX - r.lExtRelX;
  a2.relX += s2, a2.prelim -= s2, r.lExt = c3.lExt, r.lExtRelX = c3.lExtRelX;
};
var ue = (e, t, n, i) => {
  const r = e.children[t], a2 = r.rExt, c3 = e.children[t - 1];
  a2.rThr = n;
  const s2 = i - n.relX - r.rExtRelX;
  a2.relX += s2, a2.prelim -= s2, r.rExt = c3.rExt, r.rExtRelX = c3.rExtRelX;
};
var pe = (e) => {
  if (e.hasChildren) {
...
var C3 = class C4 {
  constructor(t, n) {
    this.options = C4.defaultOptions, this.revokers = [], this.handleZoom = (i) => {
      const { transform: r } = i;
      this.g.attr("transform", r);
    }, this.handlePan = (i) => {
      i.preventDefault();
      const r = transform(this.svg.node()), a2 = r.translate(
        -i.deltaX / r.k,
        -i.deltaY / r.k
      );
      ...
      (P ? i.metaKey : i.ctrlKey) && (a2 = !a2), this.toggleNode(r.data, a2);
    }, this.viewHooks = me(), this.svg = t.datum ? t : select_default2(t), this.styleNode = this.svg.append("style"), this.zoom = zoom_default2().filter((i) => this.options.scrollForPan && i.type === "wheel" ? i.ctrlKey && !i.button : (!i.ctrlKey || i.type === "wheel") && !i.button).on("zoom", this.handleZoom), this.setOptions(n), this.state = {
...
`);
  ...
  initializeData(t) {
    let n = 0;
    const { color: i, nodeMinHeight: r, maxWidth: a2, initialExpandLevel: c3 } = this.options, { id: s2 } = this.state, l = $(
      N("div", { className: `markmap-container markmap ${s2}-g` })
    ), f = $(
      N("style", { children: [this.getStyleContent(), ge].join(`
`) })
    );
    document.body.append(l, f);
    const h = a2 ? `max-width: ${a2}px` : "";
    let p = 0;
    walkTree(t, (d, S, x3) => {
      var v2, k2, w;
      d.children = (v2 = d.children) == null ? void 0 : v2.map((E2) => ({ ...E2 })), n += 1;
      const g = $(
      ...
      l.append(g), d.state = {
        ...
        id: n,
        el: g.firstChild
      }, d.state.path = [(k2 = x3 == null ? void 0 : x3.state) == null ? void 0 : k2.path, d.state.id].filter(Boolean).join("."), i(d);
      const y3 = ((w = d.payload) == null ? void 0 : w.fold) === 2;
      y3 ? p += 1 : (p || c3 >= 0 && d.depth >= c3) && (d.payload = { ...d.payload, fold: 1 }), S(), y3 && (p -= 1);
    });
    ...
    this.viewHooks.transformHtml.call(this, m), m.forEach((d) => {
      ...
      var v2;
      const g = d.state, y3 = g.el.getBoundingClientRect();
      d.content = g.el.innerHTML, g.size = [
        Math.ceil(y3.width) + 1,
        Math.max(Math.ceil(y3.height), r)
      ], g.key = [(v2 = x3 == null ? void 0 : x3.state) == null ? void 0 : v2.id, g.id].filter(Boolean).join(".") + // FIXME: find a way to check content hash
      d.content, S();
    }), l.remove(), f.remove();
  }
  setOptions(t) {
  ...
  renderData(t) {
    if (!this.state.data)
      return;
    const { spacingHorizontal: n, paddingX: i, spacingVertical: r, autoFit: a2, color: c3 } = this.options, s2 = Q({}).children((o) => {
      var u4;
      if (!((u4 = o.payload) != null && u4.fold))
        return o.children;
    }).nodeSize((o) => {
      const [u4, z] = o.data.state.size;
      return [z, u4 + (u4 ? i * 2 : 0) + n];
    }).spacing((o, u4) => o.parent === u4.parent ? r : r * 2), l = s2.hierarchy(this.state.data);
    s2(l);
    const f = l.descendants().reverse(), h = l.links(), p = linkHorizontal(), m = min(f, (o) => o.x - o.xSize / 2), d = max(f, (o) => o.x + o.xSize / 2), S = min(f, (o) => o.y), x3 = max(f, (o) => o.y + o.ySize - n);
    ...
    const g = t && f.find((o) => o.data === t) || l, y3 = g.data.state.x0 ?? g.x, v2 = g.data.state.y0 ?? g.y, k2 = this.g.selectAll(
      childSelector("g")
    ).data(f, (o) => o.data.state.key), w = k2.enter().append("g").attr("data-depth", (o) => o.data.depth).attr("data-path", (o) => o.data.state.path).attr(
      "transform",
      (o) => `translate(${v2 + g.ySize - o.ySize},${y3 + g.xSize / 2 - o.xSize})`
    ), E2 = this.transition(k2.exit());
    E2.select("line").attr("x1", (o) => o.ySize - n).attr("x2", (o) => o.ySize - n), E2.select("foreignObject").style("opacity", 0), E2.attr(
      "transform",
      (o) => `translate(${g.y + g.ySize - o.ySize},${g.x + g.xSize / 2 - o.xSize})`
    ).remove();
    const X2 = k2.merge(w).attr(
      "class",
      (o) => {
        var u4;
        return ["markmap-node", ((u4 = o.data.payload) == null ? void 0 : u4.fold) && "markmap-fold"].filter(Boolean).join(" ");
      }
    );
    this.transition(X2).attr(
      "transform",
      (o) => `translate(${o.y},${o.x - o.xSize / 2})`
    );
    const it = X2.selectAll(
      childSelector("line")
    ).data(
      (o) => [o],
      (o) => o.data.state.key
    ).join(
      (o) => o.append("line").attr("x1", (u4) => u4.ySize - n).attr("x2", (u4) => u4.ySize - n),
      (o) => o,
      (o) => o.remove()
    );
    this.transition(it).attr("x1", -1).attr("x2", (o) => o.ySize - n + 2).attr("y1", (o) => o.xSize).attr("y2", (o) => o.xSize).attr("stroke", (o) => c3(o.data)).attr("stroke-width", Y2);
    const ot = X2.selectAll(
      childSelector("circle")
    ).data(
      (o) => {
        var u4;
        return (u4 = o.data.children) != null && u4.length ? [o] : [];
      },
      (o) => o.data.state.key
    ).join(
      (o) => o.append("circle").attr("stroke-width", "1.5").attr("cx", (u4) => u4.ySize - n).attr("cy", (u4) => u4.xSize).attr("r", 0).on("click", (u4, z) => this.handleClick(u4, z)).on("mousedown", B3),
      (o) => o,
      (o) => o.remove()
    );
    this.transition(ot).attr("r", 6).attr("cx", (o) => o.ySize - n).attr("cy", (o) => o.xSize).attr("stroke", (o) => c3(o.data)).attr(
      "fill",
      (o) => {
        var u4;
        return (u4 = o.data.payload) != null && u4.fold && o.data.children ? c3(o.data) : "#fff";
      }
    );
    const rt = X2.selectAll(
      ...
      (o) => {
        const u4 = o.append("foreignObject").attr("class", "markmap-foreign").attr("x", i).attr("y", 0).style("opacity", 0).on("mousedown", B3).on("dblclick", B3);
        return u4.append("xhtml:div").select(function(T) {
          const j = T.data.state.el.cloneNode(true);
          return this.replaceWith(j), j;
        }).attr("xmlns", "http://www.w3.org/1999/xhtml"), u4;
      },
      (o) => o,
      (o) => o.remove()
    ).attr(
    ...
    const st = this.g.selectAll(
      ...
      (o) => {
        ...
        return o.insert("path", "g").attr("class", "markmap-link").attr("data-depth", (z) => z.target.data.depth).attr("data-path", (z) => z.target.data.state.path).attr("d", p({ source: u4, target: u4 }));
      },
      (o) => o,
      (o) => {
        const u4 = [
        ...
        return this.transition(o).attr("d", p({ source: u4, target: u4 })).remove();
      }
    );
    this.transition(st).attr("stroke", (o) => c3(o.target.data)).attr("stroke-width", (o) => Y2(o.target)).attr("d", (o) => {
      const u4 = o.source, z = o.target, T = [
        u4.y + u4.ySize - n,
        u4.x + u4.xSize / 2
      ], j = [
        z.y,
   ...
   */
  async fit() {
    const t = this.svg.node(), { width: n, height: i } = t.getBoundingClientRect(), { fitRatio: r } = this.options, { minX: a2, maxX: c3, minY: s2, maxY: l } = this.state, f = l - s2, h = c3 - a2, p = Math.min(
      n / f * r,
      i / h * r,
      2
  ...
  async ensureView(t, n) {
    ...
    if (this.g.selectAll(
      ...
      return;
    const r = this.svg.node(), { spacingHorizontal: a2 } = this.options, c3 = r.getBoundingClientRect(), s2 = transform(r), [l, f] = [
      i.y,
      i.y + i.ySize - a2 + 2
    ].map((y3) => y3 * s2.k + s2.x), [h, p] = [
      i.x - i.xSize / 2,
      i.x + i.xSize / 2
    ].map((y3) => y3 * s2.k + s2.y), m = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0,
      ...n
    }, d = [m.left - l, c3.width - m.right - f], S = [m.top - h, c3.height - m.bottom - p], x3 = d[0] * d[1] > 0 ? K2(d, Math.abs) / s2.k : 0, g = S[0] * S[1] > 0 ? K2(S, Math.abs) / s2.k : 0;
    if (x3 || g) {
      const y3 = s2.translate(x3, g);
   ...
   */
  async rescale(t) {
    const n = this.svg.node(), { width: i, height: r } = n.getBoundingClientRect(), a2 = i / 2, c3 = r / 2, s2 = transform(n), l = s2.translate(
      (a2 - s2.x) * (1 - t) / s2.k,
      (c3 - s2.y) * (1 - t) / s2.k
    ).scale(t);
...
function ke(e) {
  ...
  if (r) {
    const s2 = t.color || F.defaultOptions.color;
    t.color = (l) => (l = {
      ...l,
      state: {
        ...l.state,
